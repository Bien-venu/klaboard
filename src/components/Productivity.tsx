    ...
    <div className="hidden h-fit px-4 py-1 md:flex">
      <div className="relative flex flex-col">
        <div className="relative flex h-24 items-end justify-center rounded-t-xl bg-linear-to-r from-blue-500 via-purple-500 to-pink-500">
          ...
          <div className="absolute bottom-[-1.1rem] h-fit w-fit overflow-hidden rounded-lg text-white">
            <img
              src="/klaboard.png"
              alt="Klaboard"
        ...
        <div className="border-text/10 top-11 right-0 bottom-0 left-0 flex h-fit flex-col items-center gap-3 rounded-b-xl border p-4 pt-6 text-center">
          ...
          <div className="text-foreground bg-text border-text/10 flex w-full items-center justify-center rounded-lg border p-2 text-center">
            {t("productivity.upgrade")}
          </div>
        </div>
      </div>
    </div>
